...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\LieuController' => 'getLieuControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\MainPageController' => 'getMainPageControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/camurphy/bootstrap-menu-bundle/Twig/Extension/MenuExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Rw3aL5I2cz', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5qqGfwnJPV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4MC73XVIAf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MoT9ctE3ZH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\CategorieController', 'App\\Controller\\LieuController', 'App\\Controller\\LoginController', 'App\\Controller\\MainPageController', 'App\\Controller\\MaterielController', 'App\\Controller\\MemberController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        return $container->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\AssetMapper\MapperAwareAssetPackage(new \Symfony\Component\Asset\PathPackage('/startbootstrap-shop-homepage-gh-pages', new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), new \Symfony\Component\Asset\Context\RequestStackContext(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a->getBaseUrl(), $a->isSecure())), ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5ZQBCkD391', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('89tbyVK-Jx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zoi3t64kwo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6PrIpHTX1W', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lYG4iEYs0o', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ciHYGSNiJI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cDaVci+bnA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.materiels_images' => ['privates', 'vich_uploader.listener.clean.materiels_images', 'getVichUploader_Listener_Clean_MaterielsImagesService', true],
            'vich_uploader.listener.remove.materiels_images' => ['privates', 'vich_uploader.listener.remove.materiels_images', 'getVichUploader_Listener_Remove_MaterielsImagesService', true],
            'vich_uploader.listener.upload.materiels_images' => ['privates', 'vich_uploader.listener.upload.materiels_images', 'getVichUploader_Listener_Upload_MaterielsImagesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.materiels_images' => '?',
            'vich_uploader.listener.remove.materiels_images' => '?',
            'vich_uploader.listener.upload.materiels_images' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.materiels_images'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.materiels_images'], [['postFlush'], 'vich_uploader.listener.remove.materiels_images'], [['prePersist'], 'vich_uploader.listener.upload.materiels_images'], [['preUpdate'], 'vich_uploader.listener.upload.materiels_images']]);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/templates'), '!Maker');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/camurphy/bootstrap-menu-bundle/Resources/views'), 'BootstrapMenu');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/camurphy/bootstrap-menu-bundle/Resources/views'), '!BootstrapMenu');
        ...
        $instance->addExtension(new \Camurphy\BootstrapMenuBundle\Twig\Extension\MenuExtension($container->parameters['bootstrap_menu.menus'], 5, false, false));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'BootstrapMenuBundle' => 'Camurphy\\BootstrapMenuBundle\\BootstrapMenuBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'BootstrapMenuBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/camurphy/bootstrap-menu-bundle'),
            ...
            'bootstrap_menu.version' => 5,
            'bootstrap_menu.dropdown_active_style' => false,
            'bootstrap_menu.dropdown_item_active_style' => false,
            'bootstrap_menu.menus' => [
                'main' => [
                    'items' => [
                        'lieux' => [
                            'label' => 'Lieux',
                            'route' => 'app_lieu_index',
                            'roles' => [
                                0 => 'ROLE_USER',
                            ],
                            'is_divider' => false,
            ...
            'vich_uploader.mappings' => [
                'materiels_images' => [
                    'uri_prefix' => '/images/materiels',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/materiels'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.materiels_images',
                        'options' => [
