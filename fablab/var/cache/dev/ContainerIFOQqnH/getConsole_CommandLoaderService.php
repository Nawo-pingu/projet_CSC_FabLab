...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.command.mapping_debug_class' => ['privates', '.vich_uploader.command.mapping_debug_class.lazy', 'get_VichUploader_Command_MappingDebugClass_LazyService', true],
            'vich_uploader.command.mapping_debug' => ['privates', '.vich_uploader.command.mapping_debug.lazy', 'get_VichUploader_Command_MappingDebug_LazyService', true],
            'vich_uploader.command.mapping_list_classes' => ['privates', '.vich_uploader.command.mapping_list_classes.lazy', 'get_VichUploader_Command_MappingListClasses_LazyService', true],
