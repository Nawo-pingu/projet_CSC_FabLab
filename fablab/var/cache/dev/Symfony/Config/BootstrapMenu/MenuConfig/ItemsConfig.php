...
namespace Symfony\Config\BootstrapMenu\MenuConfig;

require_once __DIR__.\DIRECTORY_SEPARATOR.'ItemsConfig'.\DIRECTORY_SEPARATOR.'ItemsConfig.php';
...
class ItemsConfig 
{
    ...
    public function items(array $value = []): \Symfony\Config\BootstrapMenu\MenuConfig\ItemsConfig\ItemsConfig
    {
        $this->_usedProperties['items'] = true;

        return $this->items[] = new \Symfony\Config\BootstrapMenu\MenuConfig\ItemsConfig\ItemsConfig($value);
    }
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('items', $value)) {
            $this->_usedProperties['items'] = true;
            $this->items = array_map(fn ($v) => new \Symfony\Config\BootstrapMenu\MenuConfig\ItemsConfig\ItemsConfig($v), $value['items']);
            unset($value['items']);
        }
