...
class __TwigTemplate_a27c0a0b66257c1dd3b089895e6cdecd extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 20, $this->source); })()), "published", [], "any", false, false, false, 20)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Yes") : ("No"));
        yield "</td>
            </tr>
            <tr>
                <th>Materiel</th>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 26, $this->source); })()), "materiels", [], "any", false, false, false, 26));
        foreach ($context['_seq'] as $context["_key"] => $context["materiel"]) {
            // line 27
            yield "                    <li>
                        <a href=\"";
            // line 28
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_materiel_show", ["categorie_id" => CoreExtension::getAttribute($this->env, $this->source,             // line 30
(isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 30, $this->source); })()), "id", [], "any", false, false, false, 30), "materiel_id" => CoreExtension::getAttribute($this->env, $this->source,             // line 31
$context["materiel"], "id", [], "any", false, false, false, 31)]), "html", null, true);
            // line 33
            yield "\">";
